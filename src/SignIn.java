...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtemail, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 330, 264, 60));

        btnlogin.setBackground(new java.awt.Color(0, 0, 153));
        btnlogin.setFont(new java.awt.Font("Sitka Display", 1, 18)); // NOI18N
        ...
        getContentPane().add(btnlogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 500, 150, 50));
        ...
        getContentPane().add(txtpassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 410, 264, 60));

        jButton1.setBackground(new java.awt.Color(0, 0, 153));
        jButton1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton1.setForeground(new java.awt.Color(255, 255, 255));
        jButton1.setText("Admin Login");
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 270, 70));

        jButton2.setBackground(new java.awt.Color(0, 0, 153));
        jButton2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton2.setForeground(new java.awt.Color(255, 255, 255));
        jButton2.setText("User ID ");
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 331, 200, 60));

        jButton3.setBackground(new java.awt.Color(0, 0, 153));
        jButton3.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jButton3.setForeground(new java.awt.Color(255, 255, 255));
        jButton3.setText("Password");
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 411, 200, 60));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/rsz_a_modern_library_with_a_large_collection_of_textbooks_in_a_row_generated.jpg"))); // NOI18N
